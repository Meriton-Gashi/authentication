...
<form id="contactForm" method="POST" action="<?php echo e(route('insert')); ?>">
    <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\authentication\resources\views/dashboard.blade.php ENDPATH**/ ?>