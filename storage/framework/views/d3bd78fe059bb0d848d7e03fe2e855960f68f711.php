...
<form id="contactForm" method="POST" action="<?php echo e(route('editoContact')); ?>">
    ...
    Publish my Contact
    <input class="form-check-input" type="checkbox" name="publish" value="1" <?php echo e($lastContact->publish == 1 ? 'checked' : ''); ?>>
...
<table style="width:100%">
  ...
  <tr>
    <td>
      ...
      <input type="text" id="firstname" name="firstname" value="<?php echo e($lastContact->firstname); ?>" /><br>
      <label for="lastname">Lastname:</label>
      <input type="text" id="lastname" name="lastname" value="<?php echo e($lastContact->lastname); ?>"><br>
      <label for="address">Address:</label>
      <input type="text" id="address" name="address" value="<?php echo e($lastContact->address); ?>"><br>
      <label for="zip">Zip:</label>
      <input type="text" id="zip" name="zip"value="<?php echo e($lastContact->zip); ?>"><br>
      <label for="country">Country:</label>
        <select name="country" id="country">
            <option value="UnitedKingdom" <?php echo e($lastContact->country === 'UnitedKingdom' ? 'selected' : ''); ?>>UnitedKingdom</option>
            <option value="Albania" <?php echo e($lastContact->country === 'Albania' ? 'selected' : ''); ?>>Albania</option>
            <option value="Kosova" <?php echo e($lastContact->country === 'Kosova' ? 'selected' : ''); ?>>Kosova</option>
            <option value="UnitedStates" <?php echo e($lastContact->country === 'UnitedStates' ? 'selected' : ''); ?>>UnitedStates</option>
        </select>
    </td>
    <td>
        <div id="phoneInputs">
...
</script><?php /**PATH C:\xampp\htdocs\authentication\resources\views/editContact.blade.php ENDPATH**/ ?>